...
--    :Lazy update
--
-- NOTE: This file will contain plugins that do not require much configuration
...
return {
  ...
  -- Various lua functions many plugins use
  'nvim-lua/plenary.nvim',

  -- Tmux and split window navgation
  'christoomey/vim-tmux-navigator',

  -- Add luarocks to your lazy.nvim plugins
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      configs.setup {
        ensure_installed = { 'bash', 'c', 'cpp', 'diff', 'html', 'javascript', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
        auto_install = true,
        sync_install = false,
        modules = {},
        ignore_install = {},
